...
using Dfe.Testing.Pages.WebDriver.Internal.Provider.WebDriverFactory;
...
internal sealed class CachedWebDriverAdaptorProvider : IWebDriverAdaptorProvider, IDisposable, IAsyncDisposable
{
    ...
    private readonly WebDriver.IApplicationNavigatorAccessor _applicationNavigatorAccessor;
    ...
    public CachedWebDriverAdaptorProvider(
        ...
        WebDriver.IApplicationNavigatorAccessor applicationNavigatorAccessor)
    {
